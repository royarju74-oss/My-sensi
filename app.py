...
<title>AI SENSI GENERATOR</title>
...
<p>Best AI Sensitivity Generator</p>
...
document.getElementById("firebutton").innerHTML =
"FIRE BUTTON SIZE : " + data.fire_button;
